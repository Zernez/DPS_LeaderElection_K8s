...
class TestEnvironment:
    ...
    def test_get_details(self, logic_suite):
        ...
        assert logic_element.get_higher_nodes([{'ID': 10001, 'port': 5010,'election': True},
            ...
            {'ID': 10003, 'port': 5012,'election': True},
            {'ID': 10004, 'port': 5013,'election': True},
            {'ID': 10005, 'port': 5014,'election': True}], 10004) == [{'ID_candidate': 10005, 'port_candidate': 5014}]
    ...
    def test_ordinate_best(self, logic_suite):
        logic_element = logic_suite()
        assert logic_element.ordinate_best([{'ID_candidate': 10001, 'port_candidate': 5010},
            {'ID_candidate': 10003, 'port_candidate': 5012},
            {'ID_candidate': 10005, 'port_candidate': 5014}])== [5014, 5012, 5010]
